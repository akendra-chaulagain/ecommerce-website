    ...
    return (
        <>
            ...
            <div className="container-fuid cart">
                ...
                <div className="col-12 cartTopbar">
                    <button className='continueBtn'>Continue </button>
                    <p className='cartTopbarP'>Your Wishlist(0)</p>
                    ...
                    <div className="col-md-9" >
                        <div className="row leftSideCart" >
                            <div className="col-md-4">
                                <img className='img-fluid' src="https://images-na.ssl-images-amazon.com/images/G/01/AmazonExports/Fuji/2021/September/DashboardCards/Fuji_Dash_SmartWatch_1X._SY304_CB639922137_.jpg" alt="" />
                            </div>
                            <div className="col-md-8 leftSideproductInfo">
                                <div className="leftsideproductInfodata">
                                    <p>Product: <span>Cloth</span></p>
